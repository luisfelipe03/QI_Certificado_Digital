...
export default function SimplesNacionalPage() {
    ...
    async function loadCertificados(query: string = '', type: 'razao' | 'cnpj' = 'razao') {
        ...
        if (query === '') {
            const result = await useService.getAllByTipo('SIMPLES', page, limit);
            data = result.data;
            ...
            <div>
                ...
                <div className='flex items-center justify-between space-x-4 mb-4'>
                    ...
                    <div className='flex space-x-4 items-center'>
                        ...
                        <InputPJModal open={open} setOpen={setOpen} onAddCertificate={handleAddCertificate} tipoCertificado='SIMPLES'/>
                    </div>
                </div>
