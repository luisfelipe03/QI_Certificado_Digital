...
export const InputPFModal: React.FC<InputPFModalProps> = ({ open, setOpen, onAddCertificate }) => {
    ...
    const formik = useFormik<FormPFProps>({
        initialValues: { certificado: null, senha: '' },
        validationSchema,
        onSubmit: async (values: FormPFProps) => {
