...
import { FormPJProps, FormPJSchema, FormPJSchemaValidation } from './FormPJSchema';
...
export const InputPJModal: React.FC<InputPJModalProps> = ({ open = false, setOpen }: InputPJModalProps) => {
